...
# For the electronic vote we cannot reject the null hypothesis.

# For the polling station votes, we reject the null hypothesis.
...
# We reject the null hypothesis: that the distribution is equal across the demographic attributes.
